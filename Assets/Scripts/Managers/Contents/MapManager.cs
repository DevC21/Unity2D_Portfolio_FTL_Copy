...
public class MapManager
{
    ...
    public GameObject LoadShip(string shipName)
    {
        DestroyMap();

        string ShipName = "Ship_" + shipName;
        GameObject go = Managers.Resource.Instantiate($"Ship/{ShipName}");
        go.name = "Ship";
        ...
        // Collision 관련 파일
        TextAsset txt = Managers.Resource.Load<TextAsset>($"Ship/{ShipName}");
        StringReader reader = new StringReader(txt.text);
